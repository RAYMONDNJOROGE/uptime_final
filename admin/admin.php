...
<body>
    ...
    <div class="container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-ticket-alt"></i> Generate Admin Token</h2>
                </div>
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="recipient_email" placeholder="admin@example.com" required>
                        </div>
                        <button type="submit" class="btn">
                    ...
                    <p style="font-size: 0.85rem; color: var(--text-dim); margin-top: 15px;">
                        <i class="fas fa-info-circle"></i> Token expires in 5 minutes
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-user-shield"></i> Manage Regular Admins</h2>
